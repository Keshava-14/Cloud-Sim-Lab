	        ...
	        try {
	        	// First step: Initialize the CloudSim package. It should be called
	            	...
	            	UtilizationModel utilizationModel = new UtilizationModelFull();
                        long [] arr = new long[]{100, 400, 300, 100, 800, 200, 700, 1000};
                        for(int i = 0 ; i < 8 ; i++){
                            Cloudlet cloudlet = new Cloudlet(id, arr[i], pesNumber, arr[i], arr[i], utilizationModel, utilizationModel, utilizationModel);
	            	...
	            	broker.submitCloudletList(cloudletList);
                        ...
                        for(int i = 4 ; i < 8 ; i++){
                            broker.bindCloudletToVm(cloudletList.get(i).getCloudletId(),vm2.getId());
                        }
